...
class Agent:
    """Core Agent class executing the tool-calling loop (Decide -> Act -> Observe -> Repeat)."""
    ...
    def run(self, query: str, scratchpad: Scratchpad, max_iterations: int = 8) -> str:
        ...
        for i in range(max_iterations):
            ...
            for tool_call in tool_calls:
                ...
                if func_name in self.tool_map:
                    ...
                    self._log(f"tool not found: {func_name}")
